...
try {
    ...
    $checkQuery = "SELECT id FROM receipts WHERE id = :id AND user_id = :user_id";
    $checkStmt = $pdo->prepare($checkQuery);
    $checkStmt->bindParam(':id', $receipt_id);
    ...
    // Delete the receipt
    $deleteQuery = "DELETE FROM receipts WHERE id = :id AND user_id = :user_id";
    $deleteStmt = $pdo->prepare($deleteQuery);
    $deleteStmt->bindParam(':id', $receipt_id);
